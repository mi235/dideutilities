...
def merge_all_excels_select_fields(excel_paths, output_path, selected_fields):
    combined_data = []
...
if __name__ == "__main__":
    ...
    # ➕ Πρώτο πέρασμα για να βρούμε όλα τα διαθέσιμα πεδία
    all_columns = set()
    ...
    merge_all_excels_select_fields(input_files, output_file, selected_fields)
